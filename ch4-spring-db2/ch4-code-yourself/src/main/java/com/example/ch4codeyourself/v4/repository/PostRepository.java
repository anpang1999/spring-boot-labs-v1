...
public interface PostRepository extends JpaRepository<com.example.ch4codeyourself.v4.domain.Post,Long>, PostQueryRepository {
    ...
    List<com.example.ch4codeyourself.v4.domain.Post> findByTitleContaining(String keyword);
    ...
    // 작성일자 이후에 대한 조회
    Page<com.example.ch4codeyourself.v4.domain.Post> findByCreatedAtAfter(LocalDateTime createAt, Pageable pageable);
